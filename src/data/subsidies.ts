...
export const subsidies: Subsidy[] = [
  ...
  // ── 금융 ──
  {
    id: 13,
    title: '청년미래적금',
    description: '만 19~34세 청년이 3년간 매월 최대 50만원 납입 시 정부 기여금(6~12%)과 비과세 혜택으로 최대 2,255만원 마련 가능. 1차 모집은 마감되었으며, 2차 모집이 2026년 12월에 진행될 예정입니다.',
  ...
  },
  {
    id: 15,
    title: '근로장려금 (EITC)',
    description: '저소득 근로자·사업자 가구에 근로 의욕을 높이기 위해 장려금을 지급합니다. 근로소득자는 상반기분 반기신청이 9월 1일~15일 진행되며, 12월 말에 지급됩니다. 2026년 맞벌이 소득 기준 4,400만원으로 상향.',
  ...
  },
  {
    id: 16,
    title: '자녀장려금',
    description: '18세 미만 자녀를 양육하는 저소득 가구에 자녀 1인당 최대 100만원의 장려금을 지급합니다. 정기신청은 매년 5월이며, 기한을 놓친 경우 11월 30일까지 기한 후 신청이 가능합니다(지급액 5% 차감).',
  ...
  // ── 교육 ──
  {
    id: 29,
    title: '국가장학금 (I·II 유형)',
    description: '소득 9구간 이하 대학생에게 소득분위별 연간 최대 570만원의 등록금을 지원합니다. 2학기 2차(마지막) 신청이 9월 9일 18시에 마감되니 놓치지 마세요. 2026년 지원 대상 9구간으로 확대.',
  ...
  },
  {
    id: 40,
    title: '청년문화예술패스',
    description: '만 19~20세(2006~2007년생) 청년에게 공연·전시·영화 관람료로 쓸 수 있는 포인트를 지급합니다. 하반기 추가 발급이 진행 중이며(11월 30일까지 선착순, 예산 소진 시 조기마감), 지원금의 20% 한도 내에서 도서 구매(예스24·서점온)까지 사용처가 확대되었습니다. 포인트는 12월 31일까지 사용해야 합니다.',
